...
/**
 * Exception carrying response data received from the card until an unexpected APDU response time is
 * detected.
 *
 * @since 2.1.0
 */
public final class UnexpectedResponseTimeException extends AbstractApduException {
   ...
   * @since 2.1.0
   */
  public UnexpectedResponseTimeException(
